...
public class DiamondTopology {
    ...
    public static class DiamondBoltOutput extends BaseRichBolt {
        ...
        public DiamondBoltOutput(int time_loop, int index, long sleeptime) {
            this.time_loop = time_loop;
            this.index = index;
            this.sleeptime = sleeptime;
        }
    ...
    public static class DiamondSpout extends BaseRichSpout {
        ...
        public DiamondSpout(int time_loop, int index, long sleeptime, int numberOfCharacters, int numberOfTuples) {
            this.time_loop = time_loop;
            this.index = index;
            this.sleeptime = sleeptime;
    ...
    public static void main(String[] args) throws Exception {
        ...
        SpoutDeclarer spout = builder.setSpout("spout_node", new DiamondSpout(1, 4, 2, numberOfCharacters, numberOfTuples))
        ...
        for (int i = 1; i < numberOfTasks - 1; ++i) {
            ...
            boltDeclarers.add(
                    builder.setBolt(currentTask, new DiamondBolt(1, 2, 2))
                            .shuffleGrouping("spout_node").setCPULoad(cpuReq.get(i)).addConfiguration("task-id", firstId.toString()));
            firstId++;
        }
        BoltDeclarer output = builder.setBolt("bolt_output", new DiamondBoltOutput(1, 2, 2))
